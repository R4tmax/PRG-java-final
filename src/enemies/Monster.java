 ...
 *
 * <p>
 *     Abstract class representing different monsters
 *     - enemies - in the game
 *     Class implements HostileActions interface for
 *     implementing the common methods to be used by
 *     subtypes.
 * </p>
 *
 *
...
public abstract class Monster implements HostileActions{
     ...
     * @see HostileActions#attackPattern(int)
     */
